...
test.describe('Register User Before Checking Out Tests', () => {
	...
	test('After user creates an accout and adds products to their cart they are able to view the cart page.', async ({ page }) => {
		await page.goto('https://automationexercise.com');
		await page.getByRole('link', { name: ' Signup / Login' }).click();
		await page.locator('[data-qa="signup-name"]').fill('New User');
		await page.locator('[data-qa="signup-email"]').fill(`test+${uuidv4()}@test.com`);
	...
	test('After user creates an account and adds products to their cart they are able to procced to the view orders page.', async ({ page }) => {
		const fistName = 'New';
		const lastName = 'User';
	...
	test('After user creates an account and adds products to their cart they are able to complete an order and view place order page.', async ({ page }) => {
		await page.goto('https://automationexercise.com');
		await page.getByRole('link', { name: ' Signup / Login' }).click();
		await page.locator('[data-qa="signup-name"]').fill('New User');
		await page.locator('[data-qa="signup-email"]').fill(`test+${uuidv4()}@test.com`);
